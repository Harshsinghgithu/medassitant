...
function selectStarter(index) {
    const starters = [
        "Describe a typical session with Dr. Harley Klein and how he creates a supportive environment.",
        "Explore strategies Dr. Harley Klein might use to help a patient with anxiety disorders.",
        "Discuss the importance of empathy in Dr. Harley Klein's approach to psychotherapy.",
        "Outline the techniques Dr. Harley Klein employs to address PTSD in his patients."
    ];
...
function stepAction(stepNumber, action) {
    ...
    const actions = {
        1: () => alert('Welcome! You can start using Dr. Harley Klein right away without any registration.'),
        ...
        4: () => alert('Dr. Harley Klein will provide insights and techniques. Practice them regularly for best results.'),
        5: () => alert('Track your mood and progress over time. Dr. Harley Klein will help you identify patterns.')
    };
